...
//    #define RF24_SPI_TRANSACTIONS - Kodiak commented out to get rid of warning, unused line anyways
  #endif
...
#define RF24_SPI_TRANSACTIONS	1
  const uint32_t RF24_SPI_SPEED =   100000;		//change to 100K by Peng  
